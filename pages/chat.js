...
import ChatBoxTwo from "@/components/Chat/ChatBoxTwo";
import ChatBoxThree from "@/components/Chat/ChatBoxThree";
          ...
          <Grid item xs={12} sm={12} md={4} lg={4} xl={3}>
            <Card
              ...
              <Search className="ls-search-form">
                ...
                <StyledInputBase placeholder="Pesquisar aqui..." inputProps={{ "aria-label": "search" }} />
              </Search>
              ...
              <Typography
                ...
                <i className="ri-message-2-line"></i>Todas mensagens
              </Typography>
                  ...
                  <Box
                    ...
                    <Box textAlign="right">
                      ...
                      <Box className="mr-10px">
                        <Badge badgeContent={2} color="primary" className="for-dark-text-white"></Badge>
                      </Box>
                    </Box>
                  </Box>
                </Tab>
                  ...
                  <Box
                    ...
                    <Box
                      ...
                      <Box className="ml-1">
                        ...
                        <Typography fontSize="12px">Hello everyone ...</Typography>
                      </Box>
                    </Box>
                    ...
                    <Box textAlign="right">
                      ...
                      <Box className="mr-10px">
                        <Badge badgeContent={1} color="primary" className="for-dark-text-white"></Badge>
                      </Box>
                    </Box>
                  </Box>
                </Tab>
                  ...
                  <Box
                    ...
                    <Box
                      ...
                      <Box className="ml-1">
                        ...
                        <Typography fontSize="12px">That cool, go for it...</Typography>
                      </Box>
                    </Box>
                ...
                <Tab>
                  <Box
                    ...
                    <Box textAlign="right">
                      ...
                      <Box className="mr-10px">
                        <Badge badgeContent={5} color="primary" className="for-dark-text-white"></Badge>
                      </Box>
                    </Box>
                  </Box>
                </Tab>
