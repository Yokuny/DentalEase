    ...
    <>
      <Card
        ...
        <TableContainer
          ...
          <Table sx={{ minWidth: 900 }} aria-label="custom pagination table" className="dark-table">
            ...
            <TableBody>
              {(rowsPerPage > 0
                ...
                <TableRow key={row.orderID}>
                  ...
                  <TableCell
                    ...
                    <span className={row.badgeClass}>{row.balance}</span>
                  </TableCell>
                  ...
                  <TableCell
                    ...
                    <Box
                      ...
                      <Tooltip title="View" placement="top">
                        <IconButton aria-label="view" size="small" color="info" className="info">
              ...
              {emptyRows > 0 && (
                <TableRow style={{ height: 53 * emptyRows }}>
                  <TableCell colSpan={7} style={{ borderBottom: "1px solid #F7FAFF" }} />
                </TableRow>
              )}
            </TableBody>
