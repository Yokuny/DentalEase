const IconTask = (props: React.SVGProps<SVGSVGElement>) => (
  <svg width="1.1em" height="1.1em" viewBox="0 0 24 24" fill="none" {...props}>
    <path d="M16 3V5.63636C16 6.38948 16.6105 7 17.3636 7H20" stroke="CurrentColor" strokeWidth="1.2"></path>
    <path d="M7 11H13" stroke="CurrentColor" strokeWidth="1.2" strokeLinecap="round"></path>
    <path d="M7 15H11" stroke="CurrentColor" strokeWidth="1.2" strokeLinecap="round"></path>
    <path d="M7 7H11" stroke="CurrentColor" strokeWidth="1.2" strokeLinecap="round"></path>
    <path
    ...
    <path d="M19 17L17 15" stroke="CurrentColor" strokeWidth="1.2"></path>
    <path
